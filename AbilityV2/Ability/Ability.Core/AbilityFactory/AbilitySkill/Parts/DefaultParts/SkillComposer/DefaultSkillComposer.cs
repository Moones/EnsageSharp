...
namespace Ability.Core.AbilityFactory.AbilitySkill.Parts.DefaultParts.SkillComposer
{
    ...
    using Ability.Core.AbilityFactory.AbilitySkill.Parts.DefaultParts.Cast;
    using Ability.Core.AbilityFactory.AbilitySkill.Parts.DefaultParts.Cast.Generic;
    ...
    [AbilitySkillMetadata(ClassId.CBaseEntity)]
    internal class DefaultSkillComposer : IAbilitySkillComposer, IAbilitySkillItemComposer
    {
        ...
        public virtual void Compose(IAbilitySkill skill)
        {
            if (skill == null)
            {
                return;
