...
namespace Ability.Core.AbilityFactory.AbilityUnit.Parts.Heroes.Rubick.SkillBook
{
    ...
    internal class RubickSkillBook : SkillBook<IAbilitySkill>
    {
        #region Constructors and Destructors

        internal RubickSkillBook(IAbilityUnit unit)
            : base(unit)
        {
        }
        ...
        {
            if (skill.SourceAbility.Id == AbilityId.rubick_spell_steal)
            {
