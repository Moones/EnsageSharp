...
namespace Ability.Core.AbilityFactory.AbilityUnit.Parts.Default.SkillBook
{
        ...
        where T : IAbilitySkill
    {
        ...
        /// <summary>The talents.</summary>
        private Dictionary<double, IAbilityTalent> talents = new Dictionary<double, IAbilityTalent>();

        #endregion

        #region Constructors and Destructors

        internal SkillBook(IAbilityUnit unit)
        {
            this.Unit = unit;
        }
        ...
        public DataProvider<T> SkillAdded { get; } = new DataProvider<T>();

        public DataProvider<T> SkillRemoved { get; } = new DataProvider<T>();
        ...
        public DataProvider<IAbilityTalent> TalentAdded { get; } = new DataProvider<IAbilityTalent>();

        /// <summary>Gets or sets the talents.</summary>
        public IReadOnlyDictionary<double, IAbilityTalent> Talents
        {
            get
            {
                return this.talents;
            ...
            set
            {
                this.talents = value.ToDictionary(x => x.Key, x => x.Value);
            }
        }
        ...
        public void Dispose()
        {
            ...
            this.talents.ForEach(x => x.Value.Dispose());
            this.SkillAdded.Dispose();
            this.SkillRemoved.Dispose();
        ...
        public virtual bool IsValid(Ability ability)
        {
            ...
            return (item == null || !item.IsRecipe) && ability.Id != AbilityId.morphling_morph
                   && !ability.Name.Contains("recipe") && !ability.Name.Contains("empty")
