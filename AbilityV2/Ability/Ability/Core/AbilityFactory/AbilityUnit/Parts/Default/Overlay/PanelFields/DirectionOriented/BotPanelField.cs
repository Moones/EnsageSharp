// <copyright file="BotPanelField.cs" company="EnsageSharp">
...
namespace Ability.Core.AbilityFactory.AbilityUnit.Parts.Default.Overlay.PanelFields.DirectionOriented
{
    ...
    /// <summary>The bot panel field.</summary>
    public class BotPanelField : PanelField
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="BotPanelField" /> class.</summary>
        /// <param name="unit">The unit.</param>
        public BotPanelField(IAbilityUnit unit)
            : base(
                unit,
                unit.Overlay.ManaBar,
                () => unit.Overlay.ManaBar.Position + new Vector2(0, unit.Overlay.ManaBar.Size.Y),
