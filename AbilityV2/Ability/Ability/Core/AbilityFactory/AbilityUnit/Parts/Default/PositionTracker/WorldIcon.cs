...
namespace Ability.Core.AbilityFactory.AbilityUnit.Parts.Default.PositionTracker
{
    ...
    public class WorldIcon : ScreenStickingRectangle, IAbilityUnitPart
    {
        #region Fields
        ...
        {
            this.Unit.DataReceiver.Drawings.Remove(this.Draw);
        ...
        public void StartDrawing()
        {
            ...
            this.Unit.DataReceiver.Drawings.Add(this.Draw);
        }
