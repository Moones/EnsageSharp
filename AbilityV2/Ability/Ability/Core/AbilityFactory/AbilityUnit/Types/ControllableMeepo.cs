// <copyright file="ControllableMeepo.cs" company="EnsageSharp">
...
namespace Ability.Core.AbilityFactory.AbilityUnit.Types
{
    ...
    internal class ControllableMeepo : ControllableHero
    {
        #region Fields
        ...
        public ControllableMeepo(Unit unit)
            : base(unit)
        {
        }
                ...
                this.UnitControl.AttackAction = new AbilityAction(this, AbilityActionType.Attack)
                                                    {
                                                        ...
                                                        ExecutionIntervalSleep = 250, TryExecute = () =>
                                                            {
