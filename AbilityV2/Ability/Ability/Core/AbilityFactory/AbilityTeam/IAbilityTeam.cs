// <copyright file="IAbilityTeam.cs" company="EnsageSharp">
...
namespace Ability.Core.AbilityFactory.AbilityTeam
{
    ...
    /// <summary>
    ///     The AbilityTeam interface.
    /// </summary>
    public interface IAbilityTeam : IDisposable
    {
        ...
        /// </summary>
        ICollection<IAbilityTeam> OtherTeams { get; set; }
