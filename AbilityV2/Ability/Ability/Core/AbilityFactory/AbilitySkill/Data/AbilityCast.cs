...
namespace Ability.Core.AbilityFactory.AbilitySkill.Data
{
    ...
    public class AbilityCast : IObservable<AbilityCast>
    {
        ...
        ///     The observers.
        /// </summary>
        private readonly Collection<IObserver<AbilityCast>> observers = new Collection<IObserver<AbilityCast>>();
        ...
        public IDisposable Subscribe(IObserver<AbilityCast> observer)
        {
            ...
            return new Unsubscriber<AbilityCast>(this.observers, observer);
        }
