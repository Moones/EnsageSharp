...
namespace Ability.Core.AbilityFactory.Utilities
{
    ...
    ///     The value type
    /// </typeparam>
    public class LevelUpdater<TSource, TValueType> : IObserver<ISkillLevel>, IObserver<IUnitLevel>
    {
        #region Constructors and Destructors

        public LevelUpdater(TSource levelSkill, Func<TValueType> updateFunction)
        {
