// <copyright file="Render.cs" company="EnsageSharp">
...
namespace Ability.Utilities
{
    ...
    public static class Render
    {
        ...
        public class Circle : RenderObject
        {
            ...
            public override void OnDraw()
            {
                try
                {
                    ...
                    else if ((this.Position + _offset).ToVector2().IsValid())
                    {
        ...
        public class Rectangle : RenderObject
        {
            ...
            /// <param name="color">The color.</param>
            public Rectangle(float x, float y, float width, float height, ColorBGRA color)
            {
                this.X = x;
                this.Y = y;
                this.Width = width;
        ...
        public class Text : RenderObject
        {
                ...
                : this(text, fontName, size, color)
            {
                ...
                var pos = HUDInfo.GetHPbarPosition(unit) + offset;
